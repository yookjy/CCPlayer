...
namespace FlacBox
{
    public interface IFlacReader
    {
        FlacRecordType RecordType { get; }
        FlacStreaminfo Streaminfo { get; }
        int BlockSize { get; }
        bool Read();
        int[] ReadSubframeValues();
    ...
    /// </summary>
    public class FlacReader : IDisposable, IFlacReader
    {
        bool leaveOpen;
        Stream baseStream;
