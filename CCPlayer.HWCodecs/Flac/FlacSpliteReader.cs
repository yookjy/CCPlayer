...
namespace FlacBox
{
    public class FlacHeaderReader : IDisposable
    {
        bool leaveOpen;
        Stream baseStream;
        ...
        public FlacHeaderReader(Stream baseStream, bool leaveOpen)
        {
    ...
    public class FlacSpliteReader : IDisposable, IFlacReader
    {
        bool leaveOpen;
        Stream baseStream;
