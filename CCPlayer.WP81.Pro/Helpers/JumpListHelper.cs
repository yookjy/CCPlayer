...
{
    public class JumpListGroup<T> : ObservableCollection<T>//, INotifyCollectionChanged
    {
        /// <summary>
        ...
        //protected virtual void OnCollectionChanged(NotifyCollectionChangedAction e)
        //{
        //    if (CollectionChanged != null)
        //    {
        //        CollectionChanged(this, new NotifyCollectionChangedEventArgs(e));
        //    }
        //}
    ...
    public static class JumpListHelper
    {
            ...
            Func<TSource, TGroup> groupSelector, bool isSortDescending = false)
        {
            ...
            foreach (var g in query)
            {
                ...
                if (isSortDescending)
                {
                    foreach (var item in g.Items.Reverse())
                        group.Add(item);
