...
#define _THIS(en) ((U_NAMESPACE_QUALIFIER StringEnumeration*)(en->context))
...
ustrenum_unext(UEnumeration* en,
               ...
               UErrorCode* ec)
{
    return _THIS(en)->unext(resultLength, *ec);
}
...
ustrenum_next(UEnumeration* en,
              ...
              UErrorCode* ec)
{
    return _THIS(en)->next(resultLength, *ec);
}
