#include "pch.h"
#include "WMVSampleProvider.h"


WMVSampleProvider::WMVSampleProvider(
	FFmpegReader* reader,
...
HRESULT WMVSampleProvider::CreateMediaType(IMFMediaType** ppMediaType)
{
	HRESULT hr = S_OK;
	...
	if (SUCCEEDED(hr))
	{
		...
		case AV_CODEC_ID_WMV1:
			hr = pMediaType->SetGUID(MF_MT_SUBTYPE, MFVideoFormat_WMV1);
			break;
		case AV_CODEC_ID_WMV2:
			hr = pMediaType->SetGUID(MF_MT_SUBTYPE, MFVideoFormat_WMV2);
			break;
		default:
